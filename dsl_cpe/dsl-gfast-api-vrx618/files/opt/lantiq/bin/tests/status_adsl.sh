...
echo_all "============ Test 1 ==============="
echo_all "request various ADSL status"

for DIR in 0 1 ; do
  # Debug Status ADSL
   test_command PSDMaskDefaultGet ${line} $DIR 1
   test_command LineSpectrumDefaultGet ${line} $DIR 1
   test_command SubcarrierMaskingDefaultGet ${line} $DIR
   test_command G997_TransmitSpectrumShapingGet ${line} $DIR 1
   test_command G997_SubcarrierMaskingConfigGet ${line} $DIR
